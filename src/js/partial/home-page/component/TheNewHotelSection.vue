<template>
  <section
    ...
    class="new-hotel-section"
  >
    <div class="container">
      <div class="new-hotel-block">
          ...
          <div class="head-title-field">
            ...
            >
              <a
                ...
                @click.prevent="trackingReadmoreNewHotel(href)"
              >
                {{ $t('common.read_more') }}
              </a>
            </router-link>
        ...
        <div class="block-body">
          ...
          <template v-else>
            ...
            >
              <div class="new-hotel-swiper-wrapper swiper-wrapper">
  ...
  methods: {
    ...
    initSwiper () {
      ...
      if (
        ...
        self.itemListSwiper = new Swiper('#new-hotel__swiper-container', {
          ...SWIPER_FREEMODE_CONFIG,
          slidesPerView: 'auto',
          spaceBetween: 0,
