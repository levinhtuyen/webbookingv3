<template>
  <section
    v-if="isShowSection"
    class="horizontal-swiper-hotel-section"
  >
    <div class="container">
      <div class="horizontal-swiper-hotel-block">
        <div class="horizontal-swiper-hotel-block__head">
          <div
            v-if="hasTitleList"
            class="title-col"
          >
        ...
        </div> <!-- .horizontal-swiper-hotel-block__head -->

        <div class="horizontal-swiper-hotel-block__body">
          <div
            ref="G2jHotelSwiperContainer"
            class="horizontal-swiper-hotel-container swiper-container"
          >
            <div class="horizontal-swiper-hotel-wrap swiper-wrapper">
              <template>
                <HorizontalHotelCard
            ...
            </div> <!-- .horizontal-swiper-hotel-wrap -->
          </div> <!-- .horizontal-swiper-hotel-container -->
        </div> <!-- .horizontal-swiper-hotel-block__body -->
      </div> <!-- .horizontal-swiper-hotel-block -->
    </div> <!-- .container -->
  </section> <!-- .horizontal-swiper-hotel-section -->
</template>
...
<script>
  ...
  export default {
    components: {
      HorizontalHotelCard: () => import("./HorizontalHotelCard.vue"),
    },
