<template>
    <div>
        ...
        <div class="promotion-content-list" v-if="checkData == 1">
    ...
    export default {
        ...
        data() {
            return {
                ...
                pageSizes: 1,
                checkData: 1,
                groupSn: this.$route.query.groupSn || null,
            }
        },
        created() {
        ...
        methods: {
            ...
            getDataListPromotion() {
                ...
                apiCaller({
                    metaUrl: AJAX_URL.promotion.promotionGroup,
                    dataType: 'json',
                    method: "GET",
                    headers: {
