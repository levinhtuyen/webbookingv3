<template>
  <section
    v-if="isShowSection"
    class="g2j-horizontal-swiper-section"
  >
    <div class="container">
      <div class="g2j-horizontal-swiper-block">
        <div
          :key="language"
          class="g2j-horizontal-swiper-block__head"
        >
          <div
            v-if="hasTitleList"
            class="title-col"
        ...
        </div> <!-- .g2j-horizontal-swiper-block__head -->

        <div class="g2j-horizontal-swiper-block__body">
          <div
            ref="G2jHotelSwiperContainer"
            class="g2j-horizontal-swiper-container swiper-container"
          >
            <div class="g2j-horizontal-swiper-wrap swiper-wrapper">
              ...
              <template v-else-if="displayType == 5">
                <div
              ...
              <template v-else-if="displayType == 6">
                <G2jDarkSquareCard
                  v-for="itemInfo, idx in itemList"
                  :key="idx"
                  :is-slide="true"
              ...
              <template v-else-if="displayType == 7">
                <G2jVerticalCard
                  v-for="itemInfo, idx in itemList"
                  :key="idx"
                  :is-slide="true"
              ...
              <template v-else-if="displayType == 8">
                <G2jHorizontalCard
                  v-for="itemInfo, idx in itemList"
                  :key="idx"
                  :is-slide="true"
              ...
              <template v-else-if="displayType == 9">
                <G2jArticleCard
                  v-for="itemInfo, idx in itemList"
                  :key="idx"
                  :is-slide="true"
            ...
            </div> <!-- .g2j-horizontal-swiper-wrap -->
          </div> <!-- .g2j-horizontal-swiper-container -->
        </div> <!-- .g2j-horizontal-swiper-block__body -->
      </div> <!-- .g2j-horizontal-swiper-block -->
    </div> <!-- .container -->
  </section> <!-- .g2j-horizontal-swiper-section -->
</template>
...
<script>
  ...
  export default {
    components: {
      G2jPromotionCard: () =>
        import(
          "~jsPartialPath/global/component/g2j-promotion-card/G2jPromotionCard.vue"
        ),
      G2jDarkSquareCard: () =>
        import(
          "~jsPartialPath/global/component/g2j-dark-square-card/G2jDarkSquareCard.vue"
        ),
      G2jLightSquareCard: () =>
        import(
          "~jsPartialPath/global/component/g2j-light-square-card/G2jLightSquareCard.vue"
        ),
      G2jArticleCard: () =>
        import(
          "~jsPartialPath/global/component/g2j-article-card/G2jArticleCard.vue"
        ),
      G2jHorizontalCard: () =>
        import(
          "~jsPartialPath/global/component/g2j-horizontal-card/G2jHorizontalCard.vue"
        ),
      G2jVerticalCard: () =>
        import(
          "~jsPartialPath/global/component/g2j-vertical-card/G2jVerticalCard.vue"
        ),
    ...
    created() {
      ...
      // NOTE - Else check has list collection and init section information
    ...
    methods: {
      ...
      generateViewMoreList() {
        ...
        const _tmpSlug =
          typeof this.info.slug === "string"
            ? this.info.slug
            : _.isEmpty(this.titleList)
            ? "collection"
            : GetSlugWithoutDash(this.titleList[LANGUAGE_VALID.en]);

        // NOTE - Remove query string for SEO, then stick the sn with slug instead
