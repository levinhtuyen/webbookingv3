...
const generateTitleCase = (title) => {
  ...
  var titleSplitted = title.toLowerCase().trim().split(' ');
...
export { getSlug, getSlugWithoutDash, getUnsignedLetters, getCustomSlug, generateTitleCase, generateSentenceCase };
