const SeoTagHandler = (() => {
  ...
  const __generateDefaultHandlerSEOMetaTag = (objSetup = {
    tag: null,
    comment: null,
    init: null,
    setup: null,
  ...
  const __findSEOComments = (el) => {
    ...
    for(let i = 0; i < el.childNodes.length; i++) {
      ...
      if(
        node.nodeType === 8 &&
        /^[\s?]*(title|keywords|og\:description|description|twitter:title|robots|canonical|og\:type|og\:title|og\:url|og\:site_name|og\:image|og\:image\:width|og\:image\:height|alternate)[\s?]*$/g.test(node.textContent)
      ) {
  ...
  (() => {
    ...
    _metaTagInfoInitial = {
      title: __generateDefaultHandlerSEOMetaTag({
        tag: document.head.querySelector('title') || document.createElement('title'),
        comment: _seoCommentTagList.title || null,
      }), // title
      keywords: __generateDefaultHandlerSEOMetaTag({
        tag: (() => {
          const tmpEl = document.querySelector('meta[name="keywords"]') || document.createElement('meta');
      ...
      description: __generateDefaultHandlerSEOMetaTag({
        tag: (() => {
          const tmpEl = document.querySelector('meta[name="description"]') || document.createElement('meta');
      ...
      'og:description': __generateDefaultHandlerSEOMetaTag({
        tag: (() => {
          const tmpEl = document.querySelector('meta[property="og:description"]') || document.createElement('meta');
      ...
      'og:type': __generateDefaultHandlerSEOMetaTag({
        tag: (() => {
          const tmpEl = document.querySelector('meta[property="og:type"]') || document.createElement('meta');
      ...
      'og:title': __generateDefaultHandlerSEOMetaTag({
        tag: (() => {
          const tmpEl = document.querySelector('meta[property="og:title"]') || document.createElement('meta');
      ...
      'og:url': __generateDefaultHandlerSEOMetaTag({
        tag: (() => {
          const tmpEl = document.querySelector('meta[property="og:url"]') || document.createElement('meta');
      ...
      'og:site_name': __generateDefaultHandlerSEOMetaTag({
        tag: (() => {
          const tmpEl = document.querySelector('meta[property="og:site_name"]') || document.createElement('meta');
      ...
      'og:image': __generateDefaultHandlerSEOMetaTag({
        tag: (() => {
          const tmpEl = document.querySelector('meta[property="og:image"]') || document.createElement('meta');
      ...
      'og:image:width': __generateDefaultHandlerSEOMetaTag({
        tag: (() => {
          const tmpEl = document.querySelector('meta[property="og:image:width"]') || document.createElement('meta');
      ...
      'og:image:height': __generateDefaultHandlerSEOMetaTag({
        tag: (() => {
          const tmpEl = document.querySelector('meta[property="og:image:height"]') || document.createElement('meta');
      ...
      'twitter:title': __generateDefaultHandlerSEOMetaTag({
        tag: (() => {
          const tmpEl = document.querySelector('meta[name="twitter:title"]') || document.createElement('meta');
    ...
    _robotsMetaTagInfoInitial = __generateDefaultHandlerSEOMetaTag({
      tag: (() => {
        const tmpEl = document.head.querySelector('meta[name="robots"]') || document.createElement('meta');
      ...
      setup(objSetup) {
        ...
        if(
          ...
          _robotsMetaTagInfoInitial.comment.replaceWith(_robotsMetaTagInfoInitial.tag);
        }
    ...
    _canonicalLinkTagInfoInitial = __generateDefaultHandlerSEOMetaTag({
      tag: (() => {
        const tmpEl = document.head.querySelector('link[rel="canonical"]') || document.createElement('link');
      ...
      setup(url) {
        ...
        if(
          ...
          _canonicalLinkTagInfoInitial.comment.replaceWith(_canonicalLinkTagInfoInitial.tag);
        }
    ...
    _alternateLinkTagInfoInitial = __generateDefaultHandlerSEOMetaTag({
      tag: (() => {
        const elAlternateLinkTag = document.querySelectorAll('link[rel="alternate"]');
      ...
      init: function(lang, country) {
        ...
        if(
          ...
          _alternateLinkTagInfoInitial.tag[tmpLocaleCodeIdKey] instanceof HTMLLinkElement
        ) {
          return;
        }

        const tmpEl = document.head.querySelector('link[rel="alternate"]') || document.createElement('link');
      ...
      setup: function(url) {
        ...
        for(const localeCodeId in _alternateLinkTagInfoInitial.tag) {
          const tmpUrlWithLocaleCodeId = url.replace(/\/[A-Za-z]+(-)+[A-Za-z]+(|$)/,'/' + localeCodeId);

          _alternateLinkTagInfoInitial.tag[localeCodeId].setAttribute('href', tmpUrlWithLocaleCodeId);

          if(
            !_alternateLinkTagInfoInitial.tag[localeCodeId].parentElement &&
            _alternateLinkTagInfoInitial.comment
          ) {
            _alternateLinkTagInfoInitial.comment.before(_alternateLinkTagInfoInitial.tag[localeCodeId]);
          }
        }
